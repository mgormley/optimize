...
import static edu.jhu.hlt.util.math.LogAddTable.LOG_ADD_MIN;
import static edu.jhu.hlt.util.math.LogAddTable.logAdd;
import static edu.jhu.hlt.util.math.LogAddTable.logSubtract;
